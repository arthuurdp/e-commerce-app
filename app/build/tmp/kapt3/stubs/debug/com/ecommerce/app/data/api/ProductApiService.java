...
public abstract interface ProductApiService {
    ...
    @retrofit2.http.GET(value = "products/home")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object getHomeProducts(@retrofit2.http.Query(value = "productsPerCategory")
    int productsPerCategory, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super retrofit2.Response<java.util.List<com.ecommerce.app.data.model.product.HomeProductsResponse>>> $completion);
