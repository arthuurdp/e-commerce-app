...
import com.ecommerce.app.di.NetworkModule_ProvideCommentApiServiceFactory;
...
import com.ecommerce.app.ui.customer.payment.PaymentFailureFragment;
import com.ecommerce.app.ui.customer.payment.PaymentSuccessFragment;
...
public final class DaggerECommerceApp_HiltComponents_SingletonC {
  ...
  private static final class FragmentCImpl extends ECommerceApp_HiltComponents.FragmentC {
    ...
    @Override
    public void injectPaymentFailureFragment(PaymentFailureFragment arg0) {
    }

    @Override
    public void injectPaymentSuccessFragment(PaymentSuccessFragment arg0) {
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 2: // com.ecommerce.app.ui.auth.AuthViewModel 
  ...
  private static final class SingletonCImpl extends ECommerceApp_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideEmailApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<EmailApiService>(singletonCImpl, 8));
      this.emailRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<EmailRepository>(singletonCImpl, 7));
      this.provideCartApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<CartApiService>(singletonCImpl, 9));
      this.provideOrderApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<OrderApiService>(singletonCImpl, 10));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 12: // com.ecommerce.app.data.api.CategoryApiService 
