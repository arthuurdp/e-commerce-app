...
public data class AdminEditProductFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): AdminEditProductFragmentArgs {
      bundle.setClassLoader(AdminEditProductFragmentArgs::class.java.classLoader)
      ...
      return AdminEditProductFragmentArgs(__productId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        AdminEditProductFragmentArgs {
      val __productId : Long?
