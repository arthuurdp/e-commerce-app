...
public abstract class Hilt_SecurityFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SecurityFragment() {
    super();
  }

  Hilt_SecurityFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SecurityFragment_GeneratedInjector) this.generatedComponent()).injectSecurityFragment(UnsafeCasts.<SecurityFragment>unsafeCast(this));
    }
  }
