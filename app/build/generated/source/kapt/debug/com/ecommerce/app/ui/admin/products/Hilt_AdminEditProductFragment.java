...
public abstract class Hilt_AdminEditProductFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AdminEditProductFragment() {
    super();
  }

  Hilt_AdminEditProductFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdminEditProductFragment_GeneratedInjector) this.generatedComponent()).injectAdminEditProductFragment(UnsafeCasts.<AdminEditProductFragment>unsafeCast(this));
    }
  }
