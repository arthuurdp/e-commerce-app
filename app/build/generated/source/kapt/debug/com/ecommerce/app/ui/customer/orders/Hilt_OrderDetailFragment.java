...
public abstract class Hilt_OrderDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OrderDetailFragment() {
    super();
  }

  Hilt_OrderDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrderDetailFragment_GeneratedInjector) this.generatedComponent()).injectOrderDetailFragment(UnsafeCasts.<OrderDetailFragment>unsafeCast(this));
    }
  }
