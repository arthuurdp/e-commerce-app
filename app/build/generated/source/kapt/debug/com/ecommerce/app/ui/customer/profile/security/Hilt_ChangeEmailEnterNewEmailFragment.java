...
public abstract class Hilt_ChangeEmailEnterNewEmailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ChangeEmailEnterNewEmailFragment() {
    super();
  }

  Hilt_ChangeEmailEnterNewEmailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChangeEmailEnterNewEmailFragment_GeneratedInjector) this.generatedComponent()).injectChangeEmailEnterNewEmailFragment(UnsafeCasts.<ChangeEmailEnterNewEmailFragment>unsafeCast(this));
    }
  }
