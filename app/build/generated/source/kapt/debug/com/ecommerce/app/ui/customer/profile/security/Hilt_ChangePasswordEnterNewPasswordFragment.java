...
public abstract class Hilt_ChangePasswordEnterNewPasswordFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ChangePasswordEnterNewPasswordFragment() {
    super();
  }

  Hilt_ChangePasswordEnterNewPasswordFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChangePasswordEnterNewPasswordFragment_GeneratedInjector) this.generatedComponent()).injectChangePasswordEnterNewPasswordFragment(UnsafeCasts.<ChangePasswordEnterNewPasswordFragment>unsafeCast(this));
    }
  }
