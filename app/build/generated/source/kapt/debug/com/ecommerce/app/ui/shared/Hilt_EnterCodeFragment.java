...
public abstract class Hilt_EnterCodeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EnterCodeFragment() {
    super();
  }

  Hilt_EnterCodeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EnterCodeFragment_GeneratedInjector) this.generatedComponent()).injectEnterCodeFragment(UnsafeCasts.<EnterCodeFragment>unsafeCast(this));
    }
  }
