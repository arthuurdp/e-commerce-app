...
public abstract class Hilt_AddressListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddressListFragment() {
    super();
  }

  Hilt_AddressListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddressListFragment_GeneratedInjector) this.generatedComponent()).injectAddressListFragment(UnsafeCasts.<AddressListFragment>unsafeCast(this));
    }
  }
