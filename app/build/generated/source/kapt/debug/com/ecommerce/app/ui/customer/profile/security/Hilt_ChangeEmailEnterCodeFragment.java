...
public abstract class Hilt_ChangeEmailEnterCodeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ChangeEmailEnterCodeFragment() {
    super();
  }

  Hilt_ChangeEmailEnterCodeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChangeEmailEnterCodeFragment_GeneratedInjector) this.generatedComponent()).injectChangeEmailEnterCodeFragment(UnsafeCasts.<ChangeEmailEnterCodeFragment>unsafeCast(this));
    }
  }
