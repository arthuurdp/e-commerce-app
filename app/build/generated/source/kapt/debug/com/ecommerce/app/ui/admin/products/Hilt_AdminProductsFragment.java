...
public abstract class Hilt_AdminProductsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AdminProductsFragment() {
    super();
  }

  Hilt_AdminProductsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdminProductsFragment_GeneratedInjector) this.generatedComponent()).injectAdminProductsFragment(UnsafeCasts.<AdminProductsFragment>unsafeCast(this));
    }
  }
