...
public abstract class Hilt_ForgotPasswordEnterCodeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ForgotPasswordEnterCodeFragment() {
    super();
  }

  Hilt_ForgotPasswordEnterCodeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ForgotPasswordEnterCodeFragment_GeneratedInjector) this.generatedComponent()).injectForgotPasswordEnterCodeFragment(UnsafeCasts.<ForgotPasswordEnterCodeFragment>unsafeCast(this));
    }
  }
