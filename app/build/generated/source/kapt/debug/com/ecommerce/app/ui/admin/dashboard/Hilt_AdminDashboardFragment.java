...
public abstract class Hilt_AdminDashboardFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AdminDashboardFragment() {
    super();
  }

  Hilt_AdminDashboardFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdminDashboardFragment_GeneratedInjector) this.generatedComponent()).injectAdminDashboardFragment(UnsafeCasts.<AdminDashboardFragment>unsafeCast(this));
    }
  }
