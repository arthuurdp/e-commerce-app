...
public abstract class Hilt_AdminUsersFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AdminUsersFragment() {
    super();
  }

  Hilt_AdminUsersFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdminUsersFragment_GeneratedInjector) this.generatedComponent()).injectAdminUsersFragment(UnsafeCasts.<AdminUsersFragment>unsafeCast(this));
    }
  }
