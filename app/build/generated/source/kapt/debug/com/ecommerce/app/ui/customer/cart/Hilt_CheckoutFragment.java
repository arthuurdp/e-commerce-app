...
public abstract class Hilt_CheckoutFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CheckoutFragment() {
    super();
  }

  Hilt_CheckoutFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CheckoutFragment_GeneratedInjector) this.generatedComponent()).injectCheckoutFragment(UnsafeCasts.<CheckoutFragment>unsafeCast(this));
    }
  }
