...
public abstract class Hilt_ForgotPasswordResetPasswordFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ForgotPasswordResetPasswordFragment() {
    super();
  }

  Hilt_ForgotPasswordResetPasswordFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ForgotPasswordResetPasswordFragment_GeneratedInjector) this.generatedComponent()).injectForgotPasswordResetPasswordFragment(UnsafeCasts.<ForgotPasswordResetPasswordFragment>unsafeCast(this));
    }
  }
