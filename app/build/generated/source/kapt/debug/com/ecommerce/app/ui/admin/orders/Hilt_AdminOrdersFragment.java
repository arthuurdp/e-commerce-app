...
public abstract class Hilt_AdminOrdersFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AdminOrdersFragment() {
    super();
  }

  Hilt_AdminOrdersFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdminOrdersFragment_GeneratedInjector) this.generatedComponent()).injectAdminOrdersFragment(UnsafeCasts.<AdminOrdersFragment>unsafeCast(this));
    }
  }
