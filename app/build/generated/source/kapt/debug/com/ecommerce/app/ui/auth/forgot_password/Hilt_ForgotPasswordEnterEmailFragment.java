...
public abstract class Hilt_ForgotPasswordEnterEmailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ForgotPasswordEnterEmailFragment() {
    super();
  }

  Hilt_ForgotPasswordEnterEmailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ForgotPasswordEnterEmailFragment_GeneratedInjector) this.generatedComponent()).injectForgotPasswordEnterEmailFragment(UnsafeCasts.<ForgotPasswordEnterEmailFragment>unsafeCast(this));
    }
  }
