...
public abstract class Hilt_AdminCategoriesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AdminCategoriesFragment() {
    super();
  }

  Hilt_AdminCategoriesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdminCategoriesFragment_GeneratedInjector) this.generatedComponent()).injectAdminCategoriesFragment(UnsafeCasts.<AdminCategoriesFragment>unsafeCast(this));
    }
  }
