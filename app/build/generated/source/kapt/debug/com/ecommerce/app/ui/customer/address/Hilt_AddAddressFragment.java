...
public abstract class Hilt_AddAddressFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddAddressFragment() {
    super();
  }

  Hilt_AddAddressFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddAddressFragment_GeneratedInjector) this.generatedComponent()).injectAddAddressFragment(UnsafeCasts.<AddAddressFragment>unsafeCast(this));
    }
  }
