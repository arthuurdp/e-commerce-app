...
public final class FragmentChangePasswordEnterCodeBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentChangePasswordEnterCodeBinding(@NonNull ScrollView rootView,
  ...
  @NonNull
  public static FragmentChangePasswordEnterCodeBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentChangePasswordEnterCodeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_change_password_enter_code, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentChangePasswordEnterCodeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentChangePasswordEnterCodeBinding((ScrollView) rootView, btnBack, btnSendCode,
