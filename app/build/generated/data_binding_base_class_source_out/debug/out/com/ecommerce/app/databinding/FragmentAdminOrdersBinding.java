...
public final class FragmentAdminOrdersBinding implements ViewBinding {
  ...
  private FragmentAdminOrdersBinding(@NonNull SwipeRefreshLayout rootView,
  ...
  public static FragmentAdminOrdersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAdminOrdersBinding((SwipeRefreshLayout) rootView, progressBar, rvOrders,
